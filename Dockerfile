...
RUN go get github.com/docker/swarm && cd /go/src/github.com/docker && rm -fr swarm && git clone https://github.com/denverdino/swarm.git && cd swarm && go build && go install
