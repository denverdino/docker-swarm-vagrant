...
RUN go get github.com/docker/swarm && cd /go/src/github.com/docker && rm -fr swarm && git clone https://github.com/denverdino/swarm.git && cd /go/src/github.com/docker/docker && git checkout tags/v1.5.0 && cd /go/src/github.com/docker/libcontainer && git checkout tags/v1.4.0 && cd /go/src/github.com/docker/swarm && go build && go install
